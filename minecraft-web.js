...
export default class MinecraftClient {
  ...
  async run() {
    ...
    await downloadFileToCheerpJ(
      "https://launcher.mojang.com/mc/game/c0.0.13a/client/936d575b1ab1a04a341ad43d76e441e88d2cd987/client.jar",
      jarPath,
    ...
    const exitCode = await cheerpjRunMain("com.mojang.minecraft.Minecraft", `/app/lwjgl-2.9.3.jar:/app/lwjgl_util-2.9.3.jar:${jarPath}`)
